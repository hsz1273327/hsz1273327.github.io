...
[Sphinx](http://www.sphinx-doc.org/en/1.4.9/)是一个开源的python文档生成器,这里有一个[中文的使用手册](http://zh-sphinx-doc.readthedocs.io/en/latest/),它采用`reStructuredText`作为源文件格式,可以输出为html文件或者pdf文件(需要latex).
