...
我想到的方式是结合oculink接口,在一个db9开口中同时安装oculink和4pin端子,4pin端子仅仅是将塑料部分引出来不做固定,这样虽然看着不太好看,但功能并不受影响.有了这端子,外挂风扇也就成了可能.

至于安装方法,有oculink就先把4pin引出机箱外在固定oculink,没有就直接引出即可.
...
如果像这样增加了出风风扇,那确实可以很大程度上理顺风道,解决机箱内积热的问题.但缺陷是
...
amd的U都积热,而他在低负载下其实功耗和发热都问题不大,我们其实只用关心高于70度时的情况即可.

而如果像我一样在外面还放了个12025风扇吹风,那这个风扇主要的作用是吹主板和内存,让废热可以被尽快压出机箱.这个风扇本身大,转速就低噪音也低,就不需要这么激进,可从40度开始逐次增加转速

最终风扇策略如下:

+ CPU: (65,35),(70,50),(75,70),(80,90),(85,100)

+ System: (40,40),(60,60),(70,70),(80,80),(85,100)
